...
const reportCampaign = async (req, res) => {
    try {
        ...
        for (let i = 0; i < listImageBase64.length; i++) {
            const result = await cloudinary.uploader.upload(listImageBase64[i], {
                folder: 'public/images/report',
            });
        ...
        res.status(200).json({
            message: 'Báo cáo chiến dịch thành công',
            data: report,
        });
    } catch (error) {
        res.status(400).json({
...
const getAllReports = async (req, res) => {
    try {
        ...
        if (isAdmin) {
            ...
            const filterReports = await Report.aggregate([
                {
                    $lookup: {
                        from: 'campaigns',
                        localField: 'campaign',
...
const responseReport = async (req, res) => {
    try {
        const isAdmin = req.isAdmin;
        if (isAdmin) {
            // Xử lý
            const { id, content, images, emailUser, title} = req.body;
            const imageBuffer = [];
            const listImageBase64 = images;
            for (let i = 0; i < listImageBase64.length; i++) {
                const result = await cloudinary.uploader.upload(listImageBase64[i], {
                    folder: 'public/images/reports',
                });
                imageBuffer.push(result.secure_url);
            }
            const rp = await Report.findByIdAndUpdate(
                { _id: id },
                {
                    $set: {
                        responsed: {
            ...
            sendMail(emailUser, title, content, imageBuffer);
            rp.save();
            res.status(200).json({
...
function htmlHasImage(title, content, images) {
    ...
    * {
    ...
    <table width="100%" cellpadding="0" cellspacing="0" border="0">
      <tr>
        <td style="padding-right: 0px;padding-left: 0px;" align="center">
          ...
          <img align="center" border="0" src="https://i.imgur.com/kyuSuB1.png"alt="image" title="image" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 600px;" width="600"/>
      ...
      <tbody>
        <tr>
          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:30px 10px 10px;font-family:'Open Sans',sans-serif;" align="left">
            ...
            <h1 class="v-line-height v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Playfair Display',serif; font-size: 30px; font-weight: 400;"><span><strong>Give-fund</strong></span></h1>
            <h1 class="v-line-height v-font-size" style="margin: 0px; line-height: 140%; text-align: center; word-wrap: break-word; font-family: 'Playfair Display',serif; font-size: 20px; font-weight: 400;"><span><strong>Nền tảng website hỗ trợ gây quỹ cộng đồng</strong></span></h1>
    ...
    <table id="u_content_text_1" style="font-family:'Open Sans',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div class="v-line-height v-font-size" style="font-size: 14px; line-height: 160%; text-align: justify; word-wrap: break-word;">
        <p style="font-size: 20px; line-height: 160%; margin: 20px 0"><strong>PHẢN HỒI: ${title}</strong></p>
        <p style="font-size: 14px; line-height: 160%;"><strong>GiveFun chào bạn,</strong></p>
    ...
    <div align="left">
        <a href="/" target="_blank" class="v-button v-size-width v-font-size" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #007629; border-radius: 0px;-webkit-border-radius: 0px; -moz-border-radius: 0px; width:26%; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;font-size: 14px;">
          <span class="v-line-height" style="display:block;padding:10px 20px;line-height:120%;"><strong><span style="font-size: 14px; line-height: 16.8px;">Đến GiveFun</span></strong></span>
        </a>
    </div>
...
function htmlNoImage(title, content) {
    return `<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
    <head>
      <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
