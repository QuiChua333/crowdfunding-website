...
import logo from '~/assets/images/logoXanhLon.png'
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('inner')}>
                <div>
                    <img src={logo} style={{ width: ' 300px', objectFit: 'cover' }} />
                </div>
                <div>Cảm ơn bạn đã ủng hộ chiến dịch của chúng tôi!</div>
                <div onClick={handleClickBack} className={cx('back-btn')}> <IoIosArrowBack /> Quay về trang chiến dịch</div>
            </div>
