...
import prepost from '~/assets/images/why-image/prepost.png'
        ...
        <div className={cx('wrapper')}>
            <div className={cx('header')}>
                <div className={cx('title')}>
                    <div className={cx('title-text')}>
                        Mọi hoạt động gây quỹ đều có sự khởi đầu
                    </div>
                </div>
                <div className={cx('subtitle')}>
                    Cuộc hành trình của bạn bắt đầu từ đâu?
                </div>

            </div>
            <div onClick={handleClickStartCampaign} className={cx('option', 'crowdfunding')}>
                <div className={cx('option-title-and-subtitle')}>
                    <div className={cx('t-h4--sansSerif')}><span>Crowdfunding</span>
                    </div>
            ...
            <div className={cx('section')}>
                <div className={cx('section-title')}>
                    <div className={cx('title-text')}>
                        Chúng tôi thay đổi cách ý tưởng của bạn trở thành hiện thực
                    </div>
                </div>
            </div>
            ...
            <div style={{ display: 'flex', gap: '24px', marginTop: '72px' }}>
                <div className={cx('landing-page--campaign-card')}>
                    <div className={cx('card-image-and-badge')}>
                        <span className={cx('card-image-badge')}>
                            Đồ dùng nâng cao hiệu suất
                        </span>
                        <img src="https://c1.iggcdn.com/indiegogo-media-prod-cld/image/upload/c_fill,w_404,g_center,q_auto:best,dpr_1.3,f_auto,h_404/loupedeck-live-s-pr-image-1_loybks" width="404" height="404"
                ...
                <div className={cx('landing-page--campaign-card')}>
                    <div className={cx('card-image-and-badge')}>
                        ...
                        <img src="https://c4.iggcdn.com/indiegogo-media-prod-cld/image/upload/c_fill,w_404,g_center,q_auto:best,dpr_1.3,f_auto,h_404/kailo_2_oe5alr" width="404" height="404"
                            className={cx('card-image', 'card-image--desktop', 'imgCloudinary')} />
                    </div>
                    <div className={cx('card-title')}>
                        The Kailo Flex
                ...
                <div className={cx('landing-page--campaign-card')}>
                    <div className={cx('card-image-and-badge')}>
                        ...
                        <img src="https://c3.iggcdn.com/indiegogo-media-prod-cld/image/upload/c_fill,w_404,g_center,q_auto:best,dpr_1.3,f_auto,h_404/squareone-game-console_xubuau" width="404" height="404"
                            className={cx('card-image', 'card-image--desktop', 'imgCloudinary')} />
                    </div>
                    <div className={cx('card-title')}>
                        SquareOne Console
