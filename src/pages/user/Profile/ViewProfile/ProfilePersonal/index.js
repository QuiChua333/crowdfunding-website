            ...
            <div className={cx('body')}>
                ...
                <div className={cx('content')}>
                    ...
                    <div className={cx('container-body-profile')}>
                        <img
                            className={cx('avatar')}
                            src={user.profileImage?.url ? user.profileImage.url : defaultAvatar}
                            alt="img"
                        />
                            ...
                            <div className={cx('container-me')}>
                                <div className={cx('container-campaigns')}>
                                    ...
                                    {showModalCampaigns && (
                                        <div className={cx('modal-hover')}>
                                            Đây là số lượng chiến dịch mà tôi đã kêu gọi trên nền tảng GiveFun. Những ý
                                            tưởng mới mẽ và niềm đam mê khởi nghiệp, sáng tạo đã thúc đẩy tôi thực hiện
                                ...
                                <div className={cx('container-campaigns')}>
                                    ...
                                    {showModalContributes && (
                                        <div className={cx('modal-hover')}>
                                            Đây là số lượt đóng góp của tôi trên nền tảng GiveFun. Tôi nhìn thấy được
                                            những ý tưởng hay từ nhưng chiến dịch của những người dùng khác và tôi đã
                                            ủng hộ họ thực hiện và nhậ được rất nhiều đặc quyền và quà tặng hấp dẫn. Nó
                                            có ý nghĩa với bản thân tôi.
                                        </div>
                                    )}
                                </div>
                            </div>
