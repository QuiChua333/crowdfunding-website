                        ...
                        <h1 className={cx('section-title')} style={{ display: 'flex', alignItems: 'center' }}>
                            <span> Xác thực người dùng</span>
                            {
                                ...
                                <span style={{
                                    display: 'inline-block', padding: '4px 6px', fontSize: '11px', fontWeight: '400', lineHeight: '1.3'
                                    , color: '#fff', backgroundColor: '#0eb4b6', borderRadius: '2px', marginLeft: '20px'
                                }}>Người dùng đã xác minh</span>
                            }
                            {
                                !userState.isVerifiedUser &&
                                <span style={{
                                    display: 'inline-block', padding: '4px 6px', fontSize: '11px', fontWeight: '400', lineHeight: '1.3'
                                    , color: '#fff', backgroundColor: '#a8a8a8', borderRadius: '2px', marginLeft: '20px'
                                }}>Người dùng chưa xác minh</span>
                            }
                        </h1>
                        ...
                        <div style={{ marginTop: '24px' }}>

                            {
                                ...
                                <div className={cx('entreField')} onClick={handleClickVerify}>
                                    <a className={cx('btn', 'btn-ok')} style={{ marginLeft: '0' }} >XEM THÔNG TIN XÁC MINH</a>
                                </div>
                            }
