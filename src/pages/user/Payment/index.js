                    ...
                    <div className={cx('shipping-address')}>
                        ...
                        >
                            ...
                            <p style={{ fontSize: '11px', lineHeight: '1.5', margin: '11px 0' }}>
                                Đóng góp của bạn là một cách để hỗ trợ một cá nhân/tổ chức là chủ sở hữu chiến dịch
                                nhưng không đảm bảo rằng bạn sẽ nhận được phần thưởng.
                            </p>
                        </div>
