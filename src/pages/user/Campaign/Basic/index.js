                    ...
                    <div className={cx('body')}>
                        <div className={cx('entreSection')}>
                            ...
                            <div className={cx('entreField-subHeader')}>
                                Tạo ấn tượng tốt đầu tiên: giới thiệu mục tiêu chiến dịch của bạn và lôi kéo mọi người
                                tìm hiểu thêm. Thông tin cơ bản này sẽ đại diện cho chiến dịch của bạn trên trang chiến
                                dịch, trên thẻ chiến dịch và trong các tìm kiếm.
                            </div>
                            ...
                            <div className={cx('entreField')}>
                                ...
                                <div className={cx('entreField-subLabel')}>
                                    Tải lên hình ảnh hình vuông đại diện cho chiến dịch của bạn. Độ phân giải khuyến
                                    nghị 640 x 640, độ phân giải tối thiểu 220 x 220.
                                </div>
                                <div>
                                    <div
                                        onClick={() => {
                            ...
                            <div className={cx('entreField')}>
                                ...
                                <div className={cx('entreField-subLabel')}>
                                    Chọn vị trí nơi bạn đang/sẽ chạy chiến dịch. Vị trí này sẽ hiển thị trên trang chiến
                                    dịch của bạn để mọi người có thể xem.
                                </div>
                            ...
                            <div className={cx('entreField')}>
                                ...
                                <div className={cx('entreField-subLabel')}>
                                    Thời gian từ lúc chiến dịch của bạn được đăng tải cho đến khi nó kết thúc. Chúng tôi
                                    quy định thời gian tối đa cho mỗi chiến dịch là 60 ngày.
                                </div>
