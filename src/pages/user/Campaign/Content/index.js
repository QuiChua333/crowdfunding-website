                    ...
                    <div className={cx('body')}>
                        <div className={cx('entreSection')}>
                            ...
                            <div className={cx('entreField-subHeader')}>
                                Thêm video hoặc hình ảnh để xuất hiện trên đầu trang chiến dịch của bạn. Chiến dịch có
                                video tăng thêm 200% so với chiến dịch không có video. Giữ cho video của bạn có độ dài
                                2-3 phút.
                            </div>
                                ...
                                >
                                    <div className={cx('entreField')} style={{ position: 'relative' }}>
                                        ...
                                        <div className={cx('entreField-subLabel')}>
                                            Nhập URL YouTube để xuất hiện ở đầu trang chiến dịch của bạn. Đảm bảo video
                                            của bạn đã bật phụ đề trên Youtube.
                                        </div>
                                        <div style={{ display: 'flex', alignItems: 'center' }}>
                                            ...
                                            />
                                            <a
                                                onClick={handleClickAddRemoveVideo}
                                                href="#"
                                                className={cx('btn-add-video')}
                                            >
                                                    ...
                                                    <div className={cx('image-upload')}>
                                                        ...
                                                        <div className={cx('editFile')}>
                                                            <span className={cx('editFile-icon')}>
                                                                <MdEdit
                                                                    style={{ color: '#7a69b3', fontSize: '18px' }}
                                                                />
                                                            </span>
                                                            <span
                                                                onClick={(e) => {
                                                            ...
                                                            >
                                                                <IoCloseSharp
                                                                    style={{ color: '#7a69b3', fontSize: '22px' }}
                                                                />
                                                            </span>
                                                        </div>
                                                    </div>
                        ...
                        <div className={cx('entreSection')}>
                            ...
                            <div className={cx('entreField-subHeader')}>
                                Cho những người đóng góp tiềm năng biết thêm về chiến dịch của bạn. Cung cấp chi tiết sẽ
                                thúc đẩy mọi người đóng góp. Một chiến dịch quảng bá tốt phải hấp dẫn, nhiều thông tin
                                và dễ hiểu.
                            </div>

                            <div className={cx('entreField-subLabel')}>
                                Hình ảnh nhằm kéo dài chiều rộng của phần câu chuyện phải có chiều rộng tối thiểu là 695
                                pixel. Hình ảnh rộng hơn 695 pixel sẽ được thay đổi kích thước tương ứng.
                            </div>
                        ...
                        <div
                            style={{ marginTop: '60px', marginBottom: '60px', background: '#C8C8C8', height: '0.5px' }}
                        ></div>
                        ...
                        <div className={cx('entreSection')}>
                            ...
                            <div className={cx('entreField-subHeader')}>
                                Phần Câu hỏi thường gặp sẽ cung cấp các chi tiết phổ biến nhất mà người ủng hộ đang tìm
                                kiếm khi đánh giá chiến dịch của bạn. Các thắc mắc ban đầu về chiến dịch có thể sẽ được
                                giải quyết tại đây.
                            </div>
