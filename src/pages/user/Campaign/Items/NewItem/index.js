                        ...
                        <div className={cx('body')}>
                            <div className={cx('entreSection')}>
                                ...
                                <div className={cx('entreField-subHeader')}>
                                    Bạn quyết định những mặt hàng nào bạn muốn cung cấp cho mỗi đặc quyền trong chiến dịch của mình. Bạn sẽ có thể theo dõi đơn hàng và quản lý việc thực hiện cho từng mặt hàng.
                                </div>
                            ...
                            <div className={cx('entreSection')}>
                                ...
                                <div className={cx('entreField-subHeader')}>
                                    Bạn có muốn cung cấp các tùy chọn cho mặt hàng không (tức là người ủng hộ có được chọn màu sắc, kích thước cụ thể, v.v.) không?
                                </div>
