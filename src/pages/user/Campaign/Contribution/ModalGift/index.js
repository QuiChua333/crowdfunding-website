        ...
        <div className={cx('wrapper')}>
            <div className={cx('body')}>
                        ...
                        <div className={cx('order-container')}>
                            <div style={{ fontSize: '16px', fontWeight: 'bold', color: '#4bac4d' }}>
                                ...
                                <div className={cx('form-group')} style={{color: '#212121'}}>
                                    ...
                                    <div className={cx('info-value')}>{convertDate(gift.shippingInfo.estDelivery)}</div>
                                </div>
                ...
                <div className={cx('section-button')}>
                    ...
                    <a onClick={() => setShowModalGift(false)} className={cx('btn', 'btn-cancel')}>Đóng</a>


                    <a onClick={handleClickSave} className={cx('btn', 'btn-ok')}>Xác nhận</a>

                </div>
                <span onClick={() => setShowModalGift(false)} className={cx('editFile-icon')}><IoCloseSharp style={{ color: '#7a69b3', fontSize: '22px' }} /></span>
            </div>
        </div>
    );
}
