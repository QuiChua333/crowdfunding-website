                        ...
                        <div className={cx('delivery')}>
                            ...
                            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '16px' }}>
                                ...
                                <div style={{ position: 'relative', width: 'fit-content' }} onClick={handleMouseOverDateFilter}>
                                    <div className={cx('function-button')}>
                                        <span className={cx('btn', 'btn-succeed')} style={{ fontSize: '14px' }}>{address.estDelivery}<AiFillCaretDown style={{ marginLeft: '4px' }} /></span>
                                    </div>
                            ...
                            <div className={cx('delivery-info')}>
                                <div className={cx('info-row')}>
                                    <input className={cx('input-text')} placeholder="Họ và tên" value={address.fullName} name="fullName" onChange={handleChangeInput} />
                                    <input className={cx('input-text')} placeholder="Số điện thoại" value={address.phoneNumber} name="phoneNumber" onChange={handleChangeInput} />
                                </div>
                                <div className={cx('info-row')}>
                                    <input className={cx('input-text')} placeholder="Tỉnh / Thành phố" value={address.province} name="province" onChange={handleChangeInput} />
                                    <input className={cx('input-text')} placeholder="Quận / Huyện" value={address.district} name="district" onChange={handleChangeInput} />
                                </div>
                                <div className={cx('info-row')}>
                                    <input className={cx('input-text')} placeholder="Xã / Phường" value={address.ward} name="ward" onChange={handleChangeInput} />
                                    <input className={cx('input-text')} placeholder="Chi tiết" value={address.detail} name="detail" onChange={handleChangeInput} />
                                </div>
