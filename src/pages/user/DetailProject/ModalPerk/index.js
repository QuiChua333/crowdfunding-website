                ...
                <div className={cx('container-body')}>
                    ...
                    <div className={cx('container-layout-input')}>
                        <div className={cx('container-input')}>
                            <input className={cx('input-price')} type="number" name="price" placeholder='Nhập số tiền (VND)' onChange={(e) => setMoney(e.target.value)} value={money}/>
                            <button onClick={handleClickContinueNoPerk} className={cx('btn-continue')} type="button">Tiếp tục</button>
                        </div>
