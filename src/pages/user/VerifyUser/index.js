...
import logoTrangNho from '~/assets/images/logoTrangLon.png'
                        ...
                        <div className={cx('left-side')}>
                            ...
                            <div className={cx('return')} style={{ marginTop: '28px' }}>
                                <span onClick={handleClickBack} style={{ fontSize: '14px', fontWeight: '500' }}>
                                    <IoArrowBackSharp style={{ fontSize: '18px', marginBottom: '4px' }} /> Quay về Give
                                    Fun
                                </span>
                            </div>
                        ...
                        <div className={cx('inner')}>
                            <div className={cx('box-info')}>
                                ...
                                <p style={{ color: 'rgb(89, 97, 113)', marginTop: '8px', opacity: '0.8' }}>
                                    Thông tin này được thu thập để xác minh danh tính của bạn và giữ an toàn cho tài
                                    khoản của bạn.
                                </p>
                                ...
                                {user.isVerifiedUser ? (
                                    <>
                                        <div style={{ marginTop: '48px' }}>
                                            <span className={cx('verified')}>
                                                <TiTick style={{ color: '#fff', fontSize: '20px' }} /> Tài khoản đã được
                                                xác minh
                                            </span>
                                        </div>
                                    </>
                                    ...
                                    <>
                                        {(!user.infoVerify ||
                                            !user.infoVerify?.times ||
                                            user.infoVerify?.times === 0) && (
                                            <div style={{ marginTop: '48px' }}>
