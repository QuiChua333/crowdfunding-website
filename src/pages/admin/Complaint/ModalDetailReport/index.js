                ...
                <div className={cx('container-body')}>
                    <div className={cx('container-report')}>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                            ...
                            <a 
                                href={`/project/${report.campaignInfo._id}/detail`}
                                className={cx('btn-goto-campaign')}
                            >
                        ...
                        <div className={cx('content-report')}>
                            ...
                            <span className={cx('date-report')}>{formatDate(report.date)}</span>
                        </div>
                    </div>
                    ...
                    {report.isResponsed && (
                        <div className={cx('container-response')}>
                            ...
                            <div className={cx('content-response')}>
                                ...
                                <span className={cx('date-response')}>{formatDate(report.responsed.date)}</span>
                            </div>
                        </div>
                    )}
                </div>
